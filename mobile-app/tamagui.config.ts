...
const { tokens: baseTokens, fonts, themes: _, ...restBaseConfig } = configBase;
...
export const config = createTamagui({
  ...
  themes: {
    ...
    primary_btn: {
      ...
      color: "#ffffff",
      backgroundPress: colors["violet.80"],
      borderColor: "hsla(261, 100%, 84%, 1)",
      borderColorFocus: "hsla(261, 100%, 84%, 1)",
    ...
    secondary_btn: {
      ...
      backgroundPress: colors["violet.40"],
      borderColor: "hsla(261, 100%, 84%, 1)",
      borderColorFocus: "hsla(261, 100%, 84%, 1)",
      borderColorHover: "hsla(261, 100%, 88%, 1)",
      borderColorPress: "hsla(261, 100%, 80%, 1)",
